...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
 ...
 <!-- Header -->
  <div class="w3-container" style="margin-top:80px" id="user">
    ...
    <h1 class="w3-xxxlarge w3-text-blue"><b>Users</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
  </div>
  
 <div class="w3-container" id="user_choice">
     <button class="w3-button w3-blue w3-padding-large w3-large w3-margin-top" onclick="window.location.href='/user-create.php'">Create New User</button>
     <button class="w3-button w3-blue w3-padding-large w3-large w3-margin-top" onclick="window.location.href='/user-search.php'">Search Users</button>
